              ...
              <div className="footer-sec-xyz">
                <div className="foot11 foot12">
                  ...
                  <div className="foot10 flex flex-col">
                    ...
                    <Link href="/service/web-development" className="footLink">
                      Website Development
                    </Link>
                    <Link
                      href="/service/digital-marketing-agency"
                      className="footLink"
                    >
                      Digital Marketing
                    </Link>
                    {/* <Link to="/">Web Application Development</Link> */}
                    <Link href="/service/ui-ux-design" className="footLink">
                      UI/UX Design
                    </Link>
                    <Link href="/service/graphic-design" className="footLink">
                      Graphic Design
                    </Link>
                    <Link href="/staff-augmentation" className="footLink">
                      Staff Augmentation
                    </Link>
                    <Link
                      href="/service/multi-level-marketing"
                      className="footLink"
                    >
                ...
                <div className="foot11 foot13">
                  ...
                  <div className="foot10 reji flex flex-col">
                    ...
                    <Link href="/hire" className="footLink">
                      Hire
                    </Link>

                    <Link href="/privacy-policy" className="footLink">
                      Privacy Policy
                    </Link>

                    <Link href="/terms-conditions" className="footLink">
                      Terms & Conditions
                    </Link>
                  </div>
                </div>
