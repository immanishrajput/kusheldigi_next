          ...
          <div className="foot1 justify-between footer-first-main">
            <div className="foot11 foot111">
              <div className="foot10 footsa">
                <img width="205" height="62" loading="lazy" src='https://res.cloudinary.com/dd9tagtiw/image/upload/v1738997610/kdsKin_hydlf3.png' alt="KDS logo" title="KDS logo" />
...
https://clutch.co/profile/kushel-digi-solutions" target="blank">
           ...
           <img width="120" height="120" loading="lazy" 
            ...
            src="https://res.cloudinary.com/dbcmdtr3r/image/upload/v1743446915/8-year--6_uqroym.png"
            alt="logo"></img>
            </div>
              </div>
        </div>
