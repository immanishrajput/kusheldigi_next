    ...
    <div className="case1wrap home-main">
      ...
      <section className="case2secsec">
        <div className="case2seccont">
          ...
          <img src="https://res.cloudinary.com/dal5dlztv/image/upload/v1748270331/Group_1171279472_1_lkh4bv.png" alt="kushel" className="cs2i1" />
          ...
          <div className="sc2_main_content">
            ...
            <p>
              The expert team of Kushel Digi Solutions work on this project and build a clear roadmap to
              achieve the client’s needs. However, the journey wasn’t easy because we had to set a clear
              timeline to deliver results yet we did it successfully with combined team efforts.
            </p>
        ...
        <div className="sc3sectcont">
          ...
          <div className="s3secltleft">
            ...
            <p className="s3theeparas">
              As the challenges that we had to tackle and the client’s needs were clear, our team collaborated
              with weekly achievable targets. From creating the roadmap to the sales funnel and ensuring the
              site&#39;s peak performance, everything started with Figma.</p>

            {/* <p className="s3theeparas">
                            From creating the roadmap to the sales funnel and ensuring the site's peak performance, everything started with Figma.  </p> */}

            <p className="s3theeparas">Our designers utilized it to build some creative layouts from scratch. Once the design was ready
              with all the modern elements, the next big challenge was to decide between <strong>BigCommerce vs
                WooCommerce.</strong> Let’s see what we did next.</p>
          ...
          <section className="case3secfour" >
            ...
            <div className="cas3s4con" id="cas3s4connn">
              ...
              <div className="cas3circldata" id="cas3circldata13">
                ...
                <p>We optimized the performance of the website with the help of BigCommerce. Yes, it was the perfect platform due to an unending amount of capabilities it has. We migrated the complete website on BigCommerce so we can create a <strong>successful eCommerce platform.</strong>
                </p>
              </div>
