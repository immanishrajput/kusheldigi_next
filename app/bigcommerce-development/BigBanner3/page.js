...
const Page = () => {
  ...
  <section className="Bright-sectionEcom">
    <div className="Bicontent-blockEcom">
      <h3> BigCommerce Custom Store Development
      </h3>
      <p>
    ...
    <div className="Bicontent-blockEcom">
      <h3>BigCommerce App Integration</h3>
      <p>
    ...
    <div className="Bicontent-blockEcom">
      <h3> BigCommerce Migration Services
      </h3>
      <p>
     ...
     <div className="Bicontent-blockEcom">
      <h3>BigCommerce Performance Optimization</h3>
      <p>
