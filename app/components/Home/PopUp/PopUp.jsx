                        ...
                        <div className="pop-right-parent-div">
                            <div className="pop-rightForm">
                                ...
                                <form className="pop-contact-form" id="contactForm" onSubmit={handleSubmit}>
                                    ...
                                    <img  className="popup-companies" src='https://res.cloudinary.com/dd9tagtiw/image/upload/v1743073874/popup-upper-companies_qxbjt0.png' alt="companies" />
                                    <img  className="popup-companies" src='https://res.cloudinary.com/dd9tagtiw/image/upload/v1743073843/popup-below-companies_yboe3z.png' alt="companies"/>
                                </form>
                            </div>
                        </div>
                    </div>
