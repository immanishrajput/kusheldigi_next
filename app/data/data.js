...
export const BigCommerceServicesHeading = {
  ...
  desc: 'Kushel Digi Solutions is always committed to ensure that your BigCommerce store operates seamlessly with our expert support services. Our team is there for you from setup to maintenance, we believe in providing solutions that keep your online business running efficiently.'
}

export const BigCommerceServices = [
...
export const BigCommerceFeaturesContent = {
  title: 'Features of BigCommerce Solutions',
...
export const weExpertInBigCommerce = {
  ...
  para: 'As a certified BigCommerce partner, Kushel Digi Solutions has a successful proven track record in offering modern BigCommerce solutions to grow your business. Our experts work to make sure that your online store is not just functional but optimized for success.'
}
...
export const weExpertInMagento = {
  ...
  para: 'Kushel Digi Solutions has over 8 years of experience with a team having expertise in Magento Development Solutions. Our experts work to make sure that your online store is not just functional but also grows with the growth of your business.'
}
export const weExpertInShopify = {
  ...
  para: 'Kushel Digi Solutions has over 8 years of experience with a team having expertise in Shopify Development Solutions. Our experts work to make sure that your online store is not just functional but also grows with the growth of your business.'
}
...
export const CutsomSoftwareServicesRight = [
  {
  ...
  {
    title: "Big Data Application Services",
    description:
  ...
  {
    title: "Real-time Applications Development Services",
    description:
