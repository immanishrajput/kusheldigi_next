...
const designData = {
  paragraph: `With over 15 years of expertise, Kushel Digi Solutions has created a thorough and simple design process that includes all of the necessary parts from the wireframe stage to the completed result.
