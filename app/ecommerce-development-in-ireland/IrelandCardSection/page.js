...
import "./irelandcardsec.css";
// import Link from 'next/link'
import Image from "next/image";
import { useRouter } from "next/navigation";
function IrelandCardSection() {
  const router = useRouter();
  return (
    <section className="platforms">
      <h3 className="plt-head primary-heading">
        Which E-Commerce Platforms Do We Use to Drive Your Success?
      </h3>
      <p className="plt-para secondary-heading">
        We build online shops that are scalable, customizable, safe, and
        efficient using well-known platforms like Shopify, WooCommerce, and
        Magento. These sites can expand with your company. We can help you build
        a new website or move your old one to a different server. Our skilled
        staff takes care of every step.
      </p>
...
export default IrelandCardSection;
