  ...
  <div className="con--1">
    ...
    <div className="con--1-flex">
      <div className="con--1-flex-content">
        <img src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1744457542/Mask_group_cjywje.png" alt="" className="iconImage" />
        <h5>Slow Website Performance
        </h5>
        <p>
        A slow website can have a severe impact on customers and sales. Kushel Digi can optimize speed, enhance performance, and implement caching, CDN, and lightweight coding strategies to keep your eCommerce site as lightning fast. With our expert optimization techniques, your site will load in seconds and lower bounce rates. 
        </p>
      </div>
      <div className="con--1-flex-content">
        <img src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1744457542/Mask_group_1_typyhu.png" alt="" className="iconImage" />
      ...
      <div className="con--1-flex-content">
        <img src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1744457542/Mask_group_2_gqrmg0.png" alt="" className="iconImage" />
      ...
      <div className="con--1-flex-content">
        <img src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1744457542/Mask_group_3_ltltmy.png" alt="" className="iconImage" />
      ...
      <div className="con--1-flex-content">
        <img src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1744457541/Mask_group_4_vbyqkr.png" alt="" className="iconImage" />
      ...
      <div className="con--1-flex-content">
        <img src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1744457542/Mask_group_5_bvozp0.png" alt="" className="iconImage" />
