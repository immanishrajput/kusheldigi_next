...
import "./londoncardsec.css";
// import Link from 'next/link'
import Image from "next/image";
import { useRouter } from "next/navigation";
function NoidaCardSection() {
  const router = useRouter();
  return (
    <section className="platforms">
      <h3 className="plt-head primary-heading">
        Delivering Success with the Best E-Commerce Platforms
      </h3>
      <p className="plt-para secondary-heading">
        Kushel Digi Solutions is an expert in making safe, high-performance
        ecommerce websites using Shopify, WooCommerce, and Magento, which are
        all trusted across the globe. We provide your online shop with the
        accuracy, power, and polish it needs.
      </p>
...
export default NoidaCardSection;
