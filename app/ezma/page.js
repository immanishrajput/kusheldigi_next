...
function Page() {
    ...
    const generateMetadata = ({ params }) => ({
        ...
        description: 'See how EZMA boosted online sales with Kushel Digi Solutions custom BigCommerce website development services. Real results in this case study.',
    });
    ...
    return (
        <div className="case1wrap home-main">
            ...
            <section className="case1firsec">
                ...
                <img src="https://res.cloudinary.com/dqjbzgksw/image/upload/v1751442985/Group_1171279546_mpz7kv.png" alt="kushel" className="case1fill" />
            ...
            >
                <SplideSlide>
                    <section className="case3secfour" >
                        <img src="https://res.cloudinary.com/dqjbzgksw/image/upload/v1751442985/Group_1171279546_mpz7kv.png" alt="kushel" className="c1btimage" />
