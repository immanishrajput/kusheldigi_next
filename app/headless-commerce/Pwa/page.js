...
const tabData = {
  ...
  AppLikeExperience: {
    ...
    content1: "Headless : Installable on home screen Full-screen UI without browser chrome",
    content2: "PWA: Push notifications for offers and updates.Smooth interactions like native apps",
