...
//           <NavLink to="/contact-us"><button>LET’S TALK</button></NavLink>
//         </div>
//         <div className="learn-back2">
//           <div className="studentFrame">
//             <img src={studentsFrame} alt="student" />
//           </div>
//           <img className='student22' src={student} alt="student" />
//         </div>
//       </div>
...
//                     <NavLink to="/contact-us"><button>GET IN TOUCH</button></NavLink>
//                   </div>
//                 </div>
//                 <div className="tellUs">
//                   <div className="tellUs_right">
