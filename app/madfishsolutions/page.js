...
function Page() {
  ...
  const generateMetadata = ({ params }) => ({
    title:
      "MadFishSolutions | Ecommerce Growth with BigCommerce Website Development",
    description:
      "See how MadFishSolutions boosted online sales with Kushel Digi Solutions custom BigCommerce website development services. Real results in this case study.",
  });
  ...
  return (
    <div className="case1wrap home-main">
      ...
      <section className="case1firsec">
        <img
          src="https://res.cloudinary.com/dqjbzgksw/image/upload/v1751444966/Group_1171279566_wkicdm.png"
          alt="kushel"
          className="case1fill"
        />
            ...
            <div className="case1fifirco">
              ...
              <div className="btn-caseG">
               <p className="ca1firrigh">
                MadFish is a sustainable and elegant brand that delivers comfort
                ...
                <Link
                  ...
                  href="https://madfishsolutions.com/"
                  target="_blank"
      ...
      <section className="case3secthir">
        <div className="sc3sectcont">
          ...
          <img
            src="https://res.cloudinary.com/dqjbzgksw/image/upload/v1751444958/Group_1171279564_hkef9n.png"
            alt="kushel"
            className="c3antoimg"
          />
        </div>
