  ...
  return (
    <div className="case1wrap home-main">
      ...
      <section className="case1firsec">
        <img
          src="https://res.cloudinary.com/dqjbzgksw/image/upload/v1751438496/Group_1171279525_y9eqqo.png"
          alt="kushel"
          className="case1fill"
        />
          ...
          <div className="case1fircont">
            <div className="case1fifirco">
              ...
              <div className="ca1firleft">
                <img
                  src="https://res.cloudinary.com/dqjbzgksw/image/upload/v1751438493/Group_1171279538_hqjkvh.png"
                  alt="pinksky logo"
                />
              </div>
              ...
              <div className="btn-caseG">
                <p className="ca1firrigh">
                  In the world of women’s fashion, Pinksky is emerging as a top
                  brand in India. It is providing the best collections of
                  topwear, bottomwear, dresses, and more. Known widely for its
                  chic and contemporary choices,
                </p>
                <Link
                  className="btn-case-port"
                  href="https://pinksky.in/"
                  target="_blank"
      ...
      <section className="case2secsec">
        <div className="case2seccont">
          ...
          <div className="sc2_main_content">
            ...
            <p>
              This brand is catering to the needs of women’s fashion with
              elegance. Discover comfort and luxury, all under one platform with
              Pinksky wide collection.
            </p>
            <p>
              Though the brand was making a lot of sales, it was getting
              stagnant. The website design was one of the main challenge behind
              stagnant growth. To upscale the brand, Kushel Digi Solutions was
              approached to make the changes in the website and recreate a{" "}
      ...
      <div className="PortfolioChallenges">
        <div className="PortfolioChallengeMain">
          <h4>Challenges</h4>
          <div>
            <h5>● Slow loading speed of the products</h5>
            ...
            <h5>
              ● Poor color palette choice that didn’t match the brand aesthetic
            </h5>
          </div>
        </div>
        ...
        <div className="sc3sectcont">
          ...
          <div className="s3secltleft">
            ...
            <p className="s3theeparas">
              Keeping in mind the challenges, we had become well aware of what
              needed to be done. Our team fixed a meeting with the client to
              understand their requirements. We discussed the loopholes and the
              areas that demand high focus.
            </p>
            <p className="s3theeparas">
              So, after the discussion, we designed a fresh roadmap with
              dedicated timelines to achieve the development goals. At first, we
              picked Figma for creating the website layout, and secondly, we
              chose WordPress for the development of the entire website.
            </p>
          </div>
          <img
            src="https://res.cloudinary.com/dqjbzgksw/image/upload/v1751440272/Group_1171279524_1_otomo8.png"
            alt="kushel"
            className="c3antoimg"
          />
        </div>
      ...
      >
        <SplideSlide>
          <section className="case3secfour">
            <img
              src="https://res.cloudinary.com/dqjbzgksw/image/upload/v1751438494/image_239_o5saoa.png"
              alt="kushel"
              className="c1btimage"
            />
            ...
            <div className="cas3s4con" id="cas3s4connn">
              ...
              <div className="cas3circldata" id="cas3circldata14">
                <h4>UI/UX Preparation</h4>
                <p>
                  The U/UX of the website needed a full revamp to make it more
                  intuitive. Using Figma, we designed the UI and included some
                  new elements like CTAs to make the platform attractive. For
                  seamless performance across all devices, the team of Kushel
                  Digi made it mobile-friendly.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="case3secfour" id="case3secfour22">
            ...
            <div className="cas3s4con" id="cas3s4connn">
              ...
              <div className="cas3circldata" id="cas3circldata14">
                ...
                <p>
                  We evaluated platforms based on scalability and features.
                  After a detailed analysis of various CMS platforms, we chose{" "}
                  <strong>WordPress</strong> due to its extensive range of
                  functions. It provides access to superior backend flexibility
                  and APIs, along with some built-in SEO plugins.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="case3secfour">
            ...
            <div className="cas3s4con" id="cas3s4connn">
              ...
              <div className="cas3circldata" id="cas3circldata14">
                ...
                <p>
                  To ensure the long-term economic growth of Pinksky, we also
                  optimized the site content as per the trendy B2B commerce
                  elements. Our SEO team finalized the product descriptions
                  using SEO-friendly content. Moreover, we also added structured
                  meta tags for optimal performance.
                </p>
              </div>
            </div>
          </section>
      ...
      <div className="Mainresult_Portfolio">
        <div className="result_Portfolio">
          <h5>Result & Impact</h5>
          <p>
            After the site was ready, we noticed many signification results:
          </p>
          <ul>
            <li>
              47% increase in website traffic within the first 30 days
              post-launch
            </li>
            <li>
              The users started spending a higher average time on site,
              indicating improved engagement
            </li>
            <li>
              65% improvement in page load speed due to optimized backend and
              reduced image weights
            </li>
            <li>
              Better CRO metrics thanks to improved layout and CTA placements
            </li>
          </ul>
        </div>
      </div>
