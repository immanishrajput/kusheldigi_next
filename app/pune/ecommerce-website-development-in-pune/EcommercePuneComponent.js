...
import DetailEcomDevPune from "./DetailEcomDevPune/page";
import HeroSectionEcomPune from "./HeroEComDevPune/page";
...
function EcommercePuneComponent() {
  return (
    <div>
...
export default EcommercePuneComponent;
