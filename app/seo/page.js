          ...
          <div className="seocontainer1">
            <div className="seo_flex1">
              <div className="seo-second-heading">
                <h2>Why SEO for cannabis companies?</h2>
                <p>
                  If you want people to find your cannabis business online, then
                  you need marijuana SEO. Period.
                </p>
              </div>
              ...
              <div className="seo-third-card-main">
                <div className="seo-third-card-man">
                  ...
                  <div className="seo-second-card-flex3">    
                    ...
                    <svg width="70" height="70" viewBox="0 0 86 86" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs>
                      <filter id="filter0_d_462_386" x="0" y="0" width="86" height="86" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                    ...
                    <p>
                      We suggest, take approval and implement front end changes to
                      amplify your website design, making your webpages from
                ...
                <div className="seo-third-card-man">
                  ...
                  <div className="seo-second-card-flex-scgitem">   
                    ...
                    <h4>Technical SEO</h4>
                    <p>
                      We optimize every part of your website in lights of the
                      targeted keywords, not limited to only Meta Tags & Heading
                      tags, but the entire we take care of the entire website
                      code.
                    </p>
                  </div>
                  <div className="seo-second-card-flex3">
        ...
        <div className="seo_companies">
          <div className="seocontainer3">
            <div className="seo_flex3">
              <h3>
                Many <span>SEO companies</span> lack depth, which leads to
                ...
                <div className="seocontainer4">
                  <div className="seo_flex4">
                    <div className="seo_flex_left1">
                      <p>
                        Promoting a cannabis business online isn’t easy. Paid ads
                        are pretty much off the table, and your social media
                        accounts could be shut down at any second. So if you want
                        to drive traffic to your site, then marijuana SEO is your
                        best bet. <br />
                        A lot of agencies that do search engine optimization for
                        cannabis businesses devise strategies based on guesswork,
                        minimal data, or SEO “best practices.” This results in
                        lost traffic — or even Google penalties. This is why we
                        often find ourselves cleaning up the messes that other SEO
                        companies make.
                      </p>
                    </div>
          ...
          <div className="seo_flex7">
            ...
            <div className="seo_content123">
              ...
              <div className="right_text">
                <p>
                  We’ve worked with 35 cannabis companies to date, from
                  cannabiss seeds to CBD to local dispensaries. For each
                  sub-niche, we know the target keywords that convert into more
                  sales — and the competition for those keywords. Plus, we keep
                  an open line of communication with the top webmasters in the
                  industry.<br />
                  This way, our cannabis SEO experts can improve the position of
                  your cannabis company in search engine results 3–6 months
            ...
            <div className="seo-third-card-main2">
              <div className="seo-third-card-man2">
                <div className="seo-second-card-flex6">
                  ...
                  <h4>SEO Audit</h4>
                  <p>
                    Assess technical issues, keyword optimization, and content
                    quality. Identify weaknesses and opportunities to improve
                    your SEO.
                  </p>
                </div>
                <div className="seo-second-card-flex6">
                  ...
                  <h4>Local Seo</h4>
                  <p>
                    Attract more customers from your target area — and optimize
                    for local searches with local SEO for cannabis companies.
                  </p>
                </div>
                <div className="seo-second-card-flex6">
                  <svg
                  ...
                  <h4>Link Building</h4>
                  <p>
                    Drive your website to the top of search results with
                    high-quality, long-lasting backlinks for cannabis
                    businesses.
                  </p>
                </div>
              </div>
            ...
            <div className="SEO_EXPERTS">
              <div className="success-card">
                <div className="card3">
                  ...
                  <p>
                    First, you’ll hop on a (free) 30-minute call with an expert
                    from our team and fill them in on your business and
                    objectives.
                  </p>
                </div>
              </div>
              <div className="success-card">
                <div className="card3">
                  ...
                  <h3>Conduct A Complete Website SEO Audit</h3>
                  <p>
                    Next, we’ll analyze over 300 data points of your website and
                    SEO, identifying what’s working for cannabis marketing and
                    what’s not.
                  </p>
                </div>
              </div>
              <div className="success-card">
                <div className="card3">
                  ...
                  <h3>Craft Your SEO Strategy</h3>
                  <p>
                    Based on that, we’ll come up with a custom SEO strategy for
                    your business — one that brings qualified traffic to your
                    website.
                  </p>
                </div>
              </div>
            ...
            <div className="SEO_EXPERTS">
              <div className="success-card">
                <div className="card3">
                  ...
                  <p>
                    Based on your business needs and objectives, we’ll assign
                    competent SEO experts who are experienced in your cannabis
                    sub-niche.
                  </p>
                </div>
              </div>
              <div className="success-card">
                <div className="card3">
                  ...
                  <h3>Get Results And Scale</h3>
                  <p>
                    No cannabis marketing SEO strategy is set in stone. We’ll
                    review things weekly and continually look for ways to bring
                    to your site.
                  </p>
                </div>
              </div>
