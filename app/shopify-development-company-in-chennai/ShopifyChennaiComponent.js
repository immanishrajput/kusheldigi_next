...
import DetailShopifyChennai from "./DetailShopifyChennai/page";
import HeroShopifyChennai from "./HeroShopifyChennai/page";
...
function ShopifyChennaiComponent() {
  return (
    <div>
...
export default ShopifyChennaiComponent;
