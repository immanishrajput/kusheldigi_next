...
import HeroSectionShopify from "./HeroShopifyDelhi/page";
import DetailShopify from "./DetailShopifyDelhi/page";
...
function ShopifyDelhiComponent() {
  return (
    <div>
...
export default ShopifyDelhiComponent;
