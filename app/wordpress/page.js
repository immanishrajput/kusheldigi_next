                            ...
                            <Accordion allowZeroExpanded>
                                <AccordionItem>
                                    <AccordionItemHeading>
                                        <AccordionItemButton>
                                            WHY KUSHEL DIGI FOR WORDPRESS DEVELOPMENT?
                                        </AccordionItemButton>
                                    </AccordionItemHeading>
                                    <AccordionItemPanel>
                                        <p>
                                            Kushel Digi excels in WordPress, offering innovation, client focus, and a skilled team for tailored solutions.
                                ...
                                <AccordionItem>
                                    ...
                                    <AccordionItemPanel>
                                        <p>
                                            The time it takes to build a wordpress website depends on various factors such as the complexity of design,the number of features and functionality required ,and the availability of content.
                                        </p>
                                    </AccordionItemPanel>
                                </AccordionItem>
                                <AccordionItem>
                                    ...
                                    <AccordionItemPanel>
                                        <p>
                                            No, you do not need advance technical Knowledge to use wordpress. Its user-friendly interface and intuitive tools
                                            Make it accessible to beginners and non-technical users. However, basic familiarity with web concepts such as domains, hosting and content management is helpful.
                                        </p>
                                    </AccordionItemPanel>
                                </AccordionItem>
                                <AccordionItem>
                                    <AccordionItemHeading>
                                        <AccordionItemButton>
                                            CAN I CUSTOMISE THE DESIGN OF MY WORDPRESS WEBSITE?

                                        </AccordionItemButton>
                                    </AccordionItemHeading>
                                    <AccordionItemPanel>
                                        <p>
                                            Yes,WordPress allows for extensive Customization of website design. Users can choose from thousands of free and Premium themes to give website a unique Look and feel.
                                            Additionally, themes can be customised using built-in customization options or by editing the underlying code.
                                        </p>
                                    </AccordionItemPanel>
                                </AccordionItem>
                                <AccordionItem>
                                    ...
                                    <AccordionItemPanel>
                                        <p>
                                            WordPress plugins are software add-ons that extend the functionality of a WordPress website. There are thousands of plugins available for various purposes such as
                                            SEO optimization,contact forms,e-commerce Social media integration and more.
                                        </p>
                                    </AccordionItemPanel>
                                </AccordionItem>
                            </Accordion>
